...
--drop table public.job_data_filtered cascade;
--drop table public.job_data_raw cascade;
--drop table public.job_execution cascade;
--drop table public.job cascade;
--drop table public.job_parameter_value cascade;
--drop table public.job_extraction cascade;
--drop table public.job_filtering_filter cascade;
--drop table public.job_filtering cascade;
--drop table public.job_parameter cascade;
--drop table public.filter cascade;
--drop table public.job_execution_vw_mater cascade;
--drop table public.ops_api_cached_calls cascade;

create table public.job_extraction
(
...
create table public.job_parameter_value 
(
...
create table public.job_filtering
(
...
create table public.job_filtering_filter
(
...
CREATE TABLE public.job_data_raw
 (
...
CREATE INDEX job_execution_id_raw ON public.job_data_raw (job_execution_id);


CREATE TABLE public.job_data_filtered
 (
...
CREATE INDEX job_execution_id_filt ON public.job_data_filtered (job_execution_id);
...
CREATE TABLE public.job_execution_vw_mater
(
  job_filtering_id integer,
